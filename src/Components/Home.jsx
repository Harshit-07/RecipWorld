    ...
    <>
      <div className={classes.root}>
        ...
        <div className={classes.des}>
          <center>
            <h4>
              "Whether you're looking for healthy recipes, or ideas on how to
              use leftovers from your fridge, we've numerous recipes to choose
              from, so you'll be able to find the perfect dish"
            </h4>
          </center>
        </div>
        <div>
          <Grid container spacing={1}>
            ...
            <Grid item xs={4}>
              <Paper className={classes.paper}>
                ...
                <p>
                  Already know what you're looking for? Just type the recipe
                  name in search and choose a recipe.
                </p>
              </Paper>
            </Grid>
            <Grid item xs={4}>
